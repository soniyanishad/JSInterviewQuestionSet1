...
Q2. Difference betwwen var,let and const variables
...
( Bitwies &, |, ^, ~, <<, >>, >>>)
 ...
 Ans: I) In JavaScript, the scope chain is a crucial concept that governs the accessibility and visibility of variables and functions within a program.
   
    II) Block Scope:Variables declared in a specific block like loops,if-else,or functions,these variables will not be accessible ouside the blocks.
 It will be only accessible in the block where they have been declared.
   
  III) Local Scope: Variables declared within a JavaScript function, are LOCAL to the function.
  function myFunction() {
     let carName = "Volvo";
     code here CAN use carName
 }

 IV)Functional Scope: JavaScript has function scope: Each function creates a new scope.
